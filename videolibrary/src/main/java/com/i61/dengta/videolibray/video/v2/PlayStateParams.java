...
public class PlayStateParams {
    ...
    /**====================进度条显示样式 开始=================================*/
    /**
     * 视频当前播放/总时长，位于进度条左端样式
     */
    public static final int PROCESS_PORTRAIT_LEFT = 0;
    /**
     * 视频当前播放/总时长，位于进度条右端样式
     */
    public static final int PROCESS_PORTRAIT_RIGHT = 1;
    /**
     * 视频当前播放/总时长，位于进度条左右端样式
     */
    public static final int PROCESS_LANDSCAPE_LEFT_RIGHT = 2;
    /**
     * 视频当前播放/总时长，位于进度条左下角样式
     */
    public static final int PROCESS_CENTER = 3;
    /**====================进度条显示样式 结束=================================*/
